...
namespace osc {
    ...
    struct CameraFrameManip {
        ...
        void keyFoward() {
            cameraFrame->position -= vec2f(20, 0).x * cameraFrame->frame.vz;
        ...
        void keyLeft() {
            cameraFrame->position -= vec2f(20, 0).x * cameraFrame->frame.vx;
            cameraFrame->modified = true;
        }
        ...
        void keyUp() {
            cameraFrame->position += vec2f(20, 0).x * cameraFrame->frame.vy;
            cameraFrame->modified = true;
        }
